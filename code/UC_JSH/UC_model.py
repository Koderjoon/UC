...
class PumpedStorage:
    def __init__(self, pump):
        ...
        self.maxPump = pump['maxPower']  # Pump Data 획득 필요
...
class GetModel:
    ...
    def ReadModel(self):
        ...
        if genEmptyList:
            ...
            print(f"Code does not matching: {genEmptyList}")
        ...
        if pumpEmptyList:
            ...
            print(f"Code does not matching: {pumpEmptyList}")
        ...
        return genList, nuclearList, pumpList, essList
    ...
    def ReadGeneratorFile(self, genList, rscGenTable, genCodeList, GenType):
        ...
        if typeNum == 2:
            genCodeTable = techGenTable['대표GT코드'].to_numpy(dtype=int)
    ...
    def ReadPumpStorageFile(self, rscGenTable, pumpCodeList, pumpSOC):
        ...
        for pumpCode in pumpCodeList:
            ...
            if pumpCode in pumpCodeTable:
                techGen = techGenTable[techGenTable['발전소'] == pumpCode].iloc[0]

                pump['name'] = techGen['발전기명']
                pump['busNumber'] = 2  # 임의값

                pump['minPower'] = techGen['최소발전용량']
                pump['maxPower'] = techGen['최대발전용량']

                pump['rampUpLimit'] = techGen['출력증가율']
                pump['rampDownLimit'] = techGen['출력감소율']
                ...
                pump['maxGF'] = techGen['GF 상한']
                pump['minGF'] = techGen['GF 하한']
                pump['GFRQ'] = techGen['GFRQ']
                pump['maxLFC'] = techGen['AGC 상한']
                pump['minLFC'] = techGen['AGC 하한']
                ...
                pump['maxCapacity'] = techGen['설비용량'] * 6  # 수정 필요
                pump['isFixedSpeed'] = 1
                pump['efficiency'] = 0.85
                pump['fixedPumpPower'] = 50
    ...
    def printModelparameters(self, genList, nuclearList, pumpList, essList):
